  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-[#060a12] dark:via-[#0c1222] dark:to-[#070b14] p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-md glass-panel p-8 shadow-3d-lg dark:shadow-3d-dark-lg rounded-3xl border border-gray-200/50 dark:border-dark-border/60 hover-3d my-10 z-10"
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-display font-extrabold text-gray-900 dark:text-white mb-2">Create an Account</h2>
          <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">Join the freelance marketplace</p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <span className="text-[10px] text-center text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider">or sign up with</span>
          <span className="w-1/5 border-b border-gray-200 dark:border-dark-border lg:w-1/4"></span>
        </div>
        ...
        <p className="text-center mt-8 text-sm font-semibold text-slate-500 dark:text-slate-400">
          Already have an account? <Link to="/login" className="text-brand-green font-bold hover:underline ml-1">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
